...
const LABELS: Record<NotificationKind, string> = {
  ...
  host_new_request: "Somebody asked to book your space",
  request_submitted: "Your booking request was sent",
  host_request_reminder: "A booking request is still waiting",
  request_approved: "Your booking request was approved",
  ...
  review_submitted: "Your review was received",
  counterpart_reviewed: "Both session reviews are ready",
  review_published: "Your blind review was published",
  ...
  host_payout_sent: "Your session earnings were sent to Stripe",
