 ...
 */
export const HOST_TERMS_VERSION = 3;
...
export const HOST_TERMS_SECTIONS: readonly HostTermsSection[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Some uses are never permitted, whatever a host allows. These include sexual activity or services, adult-content production, prostitution or escort activity, anything illegal, illegal drugs, weapons where prohibited or unsafe, hazardous activities, parties and nightlife events, overnight stays or residential use, entering outside the booked time, more people than the booking declared, transferring or subletting the booking to someone else, a use materially different from the one declared, undeclared commercial production, intentional or reckless misuse of the space, furniture or equipment, and anything that damages the space or creates an unreasonable safety risk.",
